...
void PZEM004Tv30::PZEM004Tv30(uint8_t receivePin, uint8_t transmitPin, uint8_t addr)
{
 ...
 * @param addr Slave address of device
*/
void PZEM004Tv30::begin(HardwareSerial *port, uint8_t addr)
{
    port->begin(PZEM_BAUD_RATE);
    this->_serial = port;
    this->_isSoft = false;
